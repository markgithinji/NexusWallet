...
interface EVMTransactionRepository {
    ...
    fun getTransactionsByTokenType(walletId: String, evmTokenType: EVMTokenType): Flow<List<EVMTransaction>>
    ...
    suspend fun getTransactionsForTokenType(walletId: String, evmTokenType: EVMTokenType): List<EVMTransaction>
    suspend fun getPendingTransactions(): List<EVMTransaction>
    suspend fun deleteTransaction(id: String)
    suspend fun deleteAllForWallet(walletId: String)
    suspend fun deleteForWalletAndTokenType(walletId: String, evmTokenType: EVMTokenType)
    ...
    suspend fun getTokenTransaction(id: String, evmTokenType: EVMTokenType): TokenTransaction?
}